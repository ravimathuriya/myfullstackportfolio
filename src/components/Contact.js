...
const Contact = () => {
  ...
  const [Newmsg, setNewmsg ] = useState({name:"", email:"", message:""})
  ...
  const handleSubmit = (e) =>{
    e.preventDefault()
    addMsg(Newmsg.name, Newmsg.email, Newmsg.message)
    alert("Thank you ! Submitted Successfully")
    setNewmsg({name:"", email:"", message:""})
  }
        ...
        <div className="row justify-content-md-center" id='reverse'>
          ...
          <div className='col border mx-5 my-5' id='contact'>
            <div id="contact-sizing">
              <h2>Contact</h2>
              <hr />
              <form className="formcarry-form">
                <label htmlFor="name">Your Name</label>
                <br />
                <input type="text" id="name" name="name" value={Newmsg.name} onChange={onChange} required style={{width:"100%", marginBottom:"10px", borderRadius:"5px", padding:"5px"}}/>
                <br />
                <label htmlFor="email">Your Email Address</label>
                <br />
                <input type="email" id="email" name="email" value={Newmsg.email} onChange={onChange} required style={{width:"100%", marginBottom:"10px", borderRadius:"5px", padding:"5px"}}/>
                <br />
                <label htmlFor="message">Your Message</label>
                <br />
                <textarea name="message" id="message" value={Newmsg.message} onChange={onChange} cols="60" rows="10" style={{width:"100%", marginBottom:"10px", borderRadius:"5px", padding:"5px"}}></textarea>
                <br />
                <button type="submit" className="btn btn-dark" onClick={handleSubmit}>Send</button>
              </form>
